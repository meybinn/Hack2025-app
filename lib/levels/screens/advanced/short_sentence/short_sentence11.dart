...
class ShortSentence11 extends StatefulWidget {
  const ShortSentence11({
    super.key,
  });

  @override
  State<ShortSentence11> createState() => _ShortSentence11State();
}

class _ShortSentence11State extends State<ShortSentence11> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "요";
          ...
          child: Column(
            children: [
              ...
              const Row(
                ...
                children: [
                  BrailleCell(
                    active: [false, true, true, false, false, true],
                    onColor: _dotOn,
                    offColor: _dotOff,
                    size: 40,
                    hgap: 40,
