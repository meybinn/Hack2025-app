...
class ShortSentence2 extends StatefulWidget {
  const ShortSentence2({
    super.key,
  });

  @override
  State<ShortSentence2> createState() => _ShortSentence2State();
}

class _ShortSentence2State extends State<ShortSentence2> {
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => const ShortSentence3()
                      ),
                    );
                  },
                  child: const Text(
