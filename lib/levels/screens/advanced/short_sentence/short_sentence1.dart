...
class ShortSentence1 extends StatefulWidget {
  const ShortSentence1({
    super.key,
  });

  @override
  State<ShortSentence1> createState() => _ShortSentence1State();
}

class _ShortSentence1State extends State<ShortSentence1> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "축구 선수 되고 싶어요";
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => const ShortSentence2(),
                      ),
                    );
                  },
                  child: const Text(
