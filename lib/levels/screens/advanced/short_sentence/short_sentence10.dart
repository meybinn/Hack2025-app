...
import 'package:hack2025_mobile_app/levels/screens/advanced/short_sentence/short_sentence11.dart';
...
class ShortSentence10 extends StatefulWidget {
  const ShortSentence10({
    super.key,
  });

  @override
  State<ShortSentence10> createState() => _ShortSentence10State();
}

class _ShortSentence10State extends State<ShortSentence10> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "어";
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => const ShortSentence11(),
                      ),
                    );
                  },
                  child: const Text(
