...
class ShortSentence7 extends StatefulWidget {
  const ShortSentence7({
    super.key,
  });

  @override
  State<ShortSentence7> createState() => _ShortSentence7State();
}

class _ShortSentence7State extends State<ShortSentence7> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "고";
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => const ShortSentence8()
                      ),
                    );
                  },
                  child: const Text(
