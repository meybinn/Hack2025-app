...
class NumberLes3 extends StatefulWidget {
  const NumberLes3({
    super.key,
  });

  @override
  State<NumberLes3> createState() => _NumberLes3State();
}

class _NumberLes3State extends State<NumberLes3> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "팔";
            ...
            children: [
              ...
              const Row(
                ...
                children: [
                  ...
                  BrailleCell(
                    active: [true, false, true, true, false, false],
                    onColor: _dotOn,
                    offColor: _dotOff,
                    size: 40,
                    hgap: 40,
