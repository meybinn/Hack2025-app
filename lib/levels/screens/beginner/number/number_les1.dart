...
class NumberLes1 extends StatefulWidget {
  const NumberLes1({
    super.key,
  });

  @override
  State<NumberLes1> createState() => _NumberLes1State();
}

class _NumberLes1State extends State<NumberLes1> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "수표";
