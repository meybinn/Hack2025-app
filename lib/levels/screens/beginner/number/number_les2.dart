...
class NumberLes2 extends StatefulWidget {
  const NumberLes2({
    super.key,
  });

  @override
  State<NumberLes2> createState() => _NumberLes2State();
}

class _NumberLes2State extends State<NumberLes2> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "일";
