...
import 'package:hack2025_mobile_app/levels/screens/beginner/symbol/symbol_les3.dart';
import 'package:hack2025_mobile_app/levels/widgets/braille_cell.dart';

class SymbolLes2 extends StatefulWidget {
  const SymbolLes2({
    super.key,
  });

  @override
  State<SymbolLes2> createState() => _SymbolLes2State();
}

class _SymbolLes2State extends State<SymbolLes2> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "빼기";
