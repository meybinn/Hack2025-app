...
class SymbolLes3 extends StatefulWidget {
  const SymbolLes3({
    super.key,
  });

  @override
  State<SymbolLes3> createState() => _SymbolLes3State();
}

class _SymbolLes3State extends State<SymbolLes3> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "보다 작다";
