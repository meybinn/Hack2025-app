...
import 'package:hack2025_mobile_app/levels/screens/beginner/number/number_les2.dart';
...
class SymbolLes1 extends StatefulWidget {
  const SymbolLes1({
    super.key,
  });

  @override
  State<SymbolLes1> createState() => _SymbolLes1State();
}

class _SymbolLes1State extends State<SymbolLes1> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "더하기";
          ...
          child: Column(
            children: [
              ...
              const Row(
                ...
                children: [
                  BrailleCell(
                    active: [false, false, true, false, false, true],
                    onColor: _dotOn,
                    offColor: _dotOff,
                    size: 40,
                    hgap: 40,
