...
import 'package:hack2025_mobile_app/levels/screens/beginner/jamo_lesson/batchim_lesson2.dart';
import 'package:hack2025_mobile_app/levels/screens/beginner/jamo_lesson/part1_first_cons2.dart';
import 'package:hack2025_mobile_app/levels/screens/beginner/jamo_lesson/single_consonant_lesson3.dart';
...
class SingleConsonantLesson4 extends StatefulWidget {
  const SingleConsonantLesson4({
    super.key,
  });

  @override
  State<SingleConsonantLesson4> createState() => _SingleConsonantLesson4State();
}

class _SingleConsonantLesson4State extends State<SingleConsonantLesson4> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "니은";
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => SingleConsonantLesson5()
                      ),
                    );
                  },
                  child: const Text(
