...
class BatchimLesson1 extends StatefulWidget {
  const BatchimLesson1({
    super.key,
  });

  @override
  State<BatchimLesson1> createState() => _BatchimLesson1State();
}

class _BatchimLesson1State extends State<BatchimLesson1> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "니은 지읒";
            ...
            children: [
              ...
              const Row(
                ...
                children: [
                  ...
                  BrailleCell(
                    active: [true, false, false, false, true, false],
                    onColor: _dotOn,
                    offColor: _dotOff,
                    size: 40,
                    hgap: 40,
