...
import 'package:hack2025_mobile_app/levels/screens/beginner/jamo_lesson/vowel_chain_les7.dart';
import 'package:hack2025_mobile_app/levels/widgets/braille_cell.dart';

class VowelChainLes6 extends StatefulWidget {
  const VowelChainLes6({
    super.key,
  });

  @override
  State<VowelChainLes6> createState() => _VowelChainLes6State();
}

class _VowelChainLes6State extends State<VowelChainLes6> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "수액";
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => const VowelChainLes7(),
                      ),
                    );
                  },
                  child: const Text(
