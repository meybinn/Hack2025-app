...
import 'package:hack2025_mobile_app/levels/screens/beginner/jamo_lesson/vowel_lesson3.dart';
import 'package:hack2025_mobile_app/levels/widgets/braille_cell.dart';

class VowelLesson2 extends StatefulWidget {
  const VowelLesson2({
    super.key,
  });

  @override
  State<VowelLesson2> createState() => _Part1FirstConsState();
}

class _Part1FirstConsState extends State<VowelLesson2> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "야";
  ...
  Widget build(BuildContext context) {
    final List<bool> dots = [false, true, false, true, true, false];
