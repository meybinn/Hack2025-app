...
class SingleConsonantLesson1 extends StatefulWidget {
  const SingleConsonantLesson1({
    super.key,
  });

  @override
  State<SingleConsonantLesson1> createState() => _SingleConsonantLesson1State();
}

class _SingleConsonantLesson1State extends State<SingleConsonantLesson1> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "온표";
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => SingleConsonantLesson2(),
                      ),
                    );
                  },
                  child: const Text(
