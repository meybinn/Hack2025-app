...
import 'package:hack2025_mobile_app/levels/screens/beginner/jamo_lesson/vowel_lesson2.dart';
import 'package:hack2025_mobile_app/levels/widgets/braille_cell.dart';

class VowelLesson1 extends StatefulWidget {
  const VowelLesson1({
    super.key,
  });

  @override
  State<VowelLesson1> createState() => _Part1FirstConsState();
}

class _Part1FirstConsState extends State<VowelLesson1> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "아";
  ...
  Widget build(BuildContext context) {
    final List<bool> dots = [true, false, true, false, false, true];
