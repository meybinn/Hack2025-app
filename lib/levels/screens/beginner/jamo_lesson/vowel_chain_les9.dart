...
class VowelChainLes9 extends StatefulWidget {
  const VowelChainLes9({
    super.key,
  });

  @override
  State<VowelChainLes9> createState() => _VowelChainLes9State();
}

class _VowelChainLes9State extends State<VowelChainLes9> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "액";
