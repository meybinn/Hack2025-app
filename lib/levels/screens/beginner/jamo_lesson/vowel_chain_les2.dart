...
class VowelChainLes2 extends StatefulWidget {
  const VowelChainLes2({
    super.key,
  });

  @override
  State<VowelChainLes2> createState() => _VowelChainLes2State();
}

class _VowelChainLes2State extends State<VowelChainLes2> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "도예";
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => const VowelChainLes3(),
                      ),
                    );
                  },
                  child: const Text(
