...
class SingleConsonantLesson2 extends StatefulWidget {
  const SingleConsonantLesson2({
    super.key,
  });

  @override
  State<SingleConsonantLesson2> createState() => _SingleConsonantLesson2State();
}

class _SingleConsonantLesson2State extends State<SingleConsonantLesson2> {
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => SingleConsonantLesson3()
                      ),
                    );
                  },
                  child: const Text(
