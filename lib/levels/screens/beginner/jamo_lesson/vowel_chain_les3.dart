...
import 'package:hack2025_mobile_app/levels/screens/beginner/jamo_lesson/vowel_chain_les4.dart';
import 'package:hack2025_mobile_app/levels/widgets/braille_cell.dart';

class VowelChainLes3 extends StatefulWidget {
  const VowelChainLes3({
    super.key,
  });

  @override
  State<VowelChainLes3> createState() => _VowelChainLes3State();
}

class _VowelChainLes3State extends State<VowelChainLes3> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "도";
            ...
            children: [
              ...
              const Row(
                ...
                children: [
                  ...
                  BrailleCell(
                    active: [true, false, false, false, true, true],
                    onColor: _dotOn,
                    offColor: _dotOff,
                    size: 40,
                    hgap: 40,
