...
class SingleConsonantLesson5 extends StatefulWidget {
  const SingleConsonantLesson5({
    super.key,
  });

  @override
  State<SingleConsonantLesson5> createState() => _SingleConsonantLesson5State();
}

class _SingleConsonantLesson5State extends State<SingleConsonantLesson5> {
