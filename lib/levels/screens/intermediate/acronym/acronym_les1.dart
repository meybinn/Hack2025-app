...
class AcronymLes1 extends StatefulWidget {
  const AcronymLes1({
    super.key,
  });

  @override
  State<AcronymLes1> createState() => _AcronymLes1State();
}

class _AcronymLes1State extends State<AcronymLes1> {
  final FlutterTts _tts = FlutterTts();
  bool _isSpeaking = false;
  bool _navigated = false;

  static const String _utterance = "그래서";
            ...
            children: [
              ...
              const Row(
                ...
                children: [
                  ...
                  BrailleCell(
                    active: [false, true, true, false, true, false],
                    onColor: _dotOn,
                    offColor: _dotOff,
                    size: 40,
                    hgap: 40,
