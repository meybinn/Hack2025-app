...
class AbbreviationLesson1 extends StatefulWidget {
  ...
  @override
  State<AbbreviationLesson1> createState() => _Part1FirstConsState();
}

class _Part1FirstConsState extends State<AbbreviationLesson1> {
  ...
  Widget build(BuildContext context) {
    final List<bool> dots = [true, true, true, false, false, true];
