...
class AbbreviationLesson2 extends StatefulWidget {
  ...
  @override
  State<AbbreviationLesson2> createState() => _Part1FirstConsState();
}

class _Part1FirstConsState extends State<AbbreviationLesson2> {
  ...
  Widget build(BuildContext context) {
    final List<bool> dots = [false, true, true, true, false, false];
