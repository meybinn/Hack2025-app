...
class VocabLes6 extends StatefulWidget {
  const VocabLes6({
    super.key,
  });

  @override
  State<VocabLes6> createState() => _VocabLes6State();
}

class _VocabLes6State extends State<VocabLes6> {
          ...
          child: Column(
            children: [
              ...
              const Row(
                ...
                children: [
                  BrailleCell(
                    active: [false, true, false, false, true, true],
                    onColor: _dotOn,
                    offColor: _dotOff,
                    size: 40,
                    hgap: 40,
